...
const routes: Routes = [
  ...
  { path: 'alta-duenio/:id', loadChildren: './pages/alta-duenio/alta-duenio.module#AltaDuenioPageModule' },
  { path: 'signup', loadChildren: './pages/signup/signup.module#SignupPageModule' },
  { path: 'alta-empleado/:id', loadChildren: './pages/alta-empleado/alta-empleado.module#AltaEmpleadoPageModule' },
  { path: 'alta-mesa/:id', loadChildren: './pages/alta-mesa/alta-mesa.module#AltaMesaPageModule' },
  {path: 'comida-create/:id',  loadChildren: './pages/comida-create/comida-create.module#ComidaCreatePageModule',canActivate: [AuthGuard]},
  {path: 'comida-detail/:id/:lenguaje', loadChildren: './pages/comida-detail/comida-detail.module#ComidaDetailPageModule',canActivate: [AuthGuard] },
  { path: 'comida-list', loadChildren: './pages/comida-list/comida-list.module#ComidaListPageModule' },
  { path: 'comida-list/:id', loadChildren: './pages/comida-list/comida-list.module#ComidaListPageModule' },
  ...
  { path: 'abrir-mesa/:id', loadChildren: './pages/abrir-mesa/abrir-mesa.module#AbrirMesaPageModule' },
  { path: 'cerrar-mesa/:id', loadChildren: './pages/cerrar-mesa/cerrar-mesa.module#CerrarMesaPageModule' },
  { path: 'qrmesa', loadChildren: './pages/qrmesa/qrmesa.module#QrmesaPageModule' },
  { path: 'alta-pedido/:id', loadChildren: './pages/alta-pedido/alta-pedido.module#AltaPedidoPageModule' },
  { path: 'encuesta-empleado/:id', loadChildren: './pages/encuesta-empleado-create/encuesta-empleado-create.module#EncuestaEmpleadoCreatePageModule' },
  { path: 'encuesta-graficos/:id', loadChildren: './pages/encuesta-graficos/encuesta-graficos.module#EncuestaGraficosPageModule' },
  { path: 'juego-postre', loadChildren: './pages/juego-postre/juego-postre.module#JuegoPostrePageModule' },
  { path: 'tomarpedidos/:id', loadChildren: './pages/tomarpedidos/tomarpedidos.module#TomarpedidosPageModule' },
  { path: 'reserva-cliente/:id', loadChildren: './pages/reserva-cliente/reserva-cliente.module#ReservaClientePageModule' },
  ...
  { path: 'ingreso/:id', loadChildren: './pages/ingreso/ingreso.module#IngresoPageModule' },
  { path: 'tomarpedidococina/:id', loadChildren: './pages/tomarpedidococina/tomarpedidococina.module#TomarpedidococinaPageModule' },
  { path: 'carta', loadChildren: './pages/carta/carta.module#CartaPageModule' },
  { path: 'cuenta/:id', loadChildren: './pages/cuenta/cuenta.module#CuentaPageModule' },
  ...
  { path: 'habilitar-reservas/:id', loadChildren: './pages2/habilitar-reservas/habilitar-reservas.module#HabilitarReservasPageModule' },
  ...
  { path: 'tipo-registro/:id', loadChildren: './pages/tipo-registro/tipo-registro.module#TipoRegistroPageModule' },
  { path: 'alta-cliente', loadChildren: './pages/alta-cliente/alta-cliente.module#AltaClientePageModule' },
  { path: 'alta-cliente/:id', loadChildren: './pages/alta-cliente/alta-cliente.module#AltaClientePageModule' },
  { path: 'clienteconfirmapedido', loadChildren: './pages2/clienteconfirmapedido/clienteconfirmapedido.module#ClienteconfirmapedidoPageModule' }, 
   ...
   { path: 'alta-anonimo/:id', loadChildren: './pages/alta-anonimo/alta-anonimo.module#AltaAnonimoPageModule' },
   { path: 'lista-clientes/:id', loadChildren: './pages/lista-clientes/lista-clientes.module#ListaClientesPageModule' },
  { path: 'tab1', loadChildren: './tab1/tab1.module#Tab1PageModule' },
  { path: 'tab1/:id', loadChildren: './tab1/tab1.module#Tab1PageModule' },
